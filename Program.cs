    ...
    static void Main(string[] args)
    {
        ...
        switch (sw)
        {
            case 1:
                ...
                String CRC64_hexadecimal = b.Get_CRC64_ECMA182().ToString("X");
            ...
            case 2:
                ...
                CRC64_hexadecimal = b.Get_CRC64_WE().ToString("X");
...
{
    private static readonly UInt64[] crc64_table = new UInt64[256] {
    ...
    public static ulong Get_CRC64_ECMA182(this byte[] Data)
    {
        ulong crc = 0x0000000000000000;
        for (int i = 0; i < Data.Length; i++)
        {
            uint tableIndex = (((uint)(crc >> 56)) ^ Data[i]) & 0xff;
            crc = crc64_table[tableIndex] ^ (crc << 8);
        }
        return (crc ^ 0x0000000000000000);
    }

    public static ulong Get_CRC64_WE(this byte[] Data)
    {
